...
<head>
    ...
    <style>
        ...
        .employee-attendance-row { display: flex; align-items: center; padding: 10px; border-bottom: 1px solid #eee; }
        .employee-image { width: 50px; height: 50px; border-radius: 50%; margin-right: 15px; }
        .employee-details { display: flex; flex-grow: 1; justify-content: space-between; }
        .employee-details span { flex-basis: 14%; text-align: center; }
        #cameraOptions, #attendanceTypeOptions {
            margin-bottom: 10px;
        }
    </style>
</head>
<body>
    <div class="sidenav">
        ...
        <div class="menu">
            ...
            <a href="all_employee.php"><button>Employee</button></a>
            <a href="emp_attendance.php"><button>Attendance</button></a>
    ...
    <div class="main-content">
        ...
        <div class="content-section">
            ...
            <div class="button-group">
                <a href="attendance_reports.php" class="report-button">Reports</a>
        ...
        function pollAttendanceResult() {
            ...
            const pollInterval = setInterval(() => {
                fetch('attendance_log.php', {
                    ...
                    body: JSON.stringify({ action: 'check_result' })
                })
                .then(response => response.json())
                .then(data => {
