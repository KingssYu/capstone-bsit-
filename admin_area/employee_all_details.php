...
if ($employee_no) {
    ...
    $sql = "SELECT * FROM adding_employee LEFT JOIN rate_position ON adding_employee.rate_id = rate_position.rate_id WHERE employee_no = '$employee_no'";
...
<body>
    <header>
        <div class="left-section">
            <a href="./dashboard.php" style="text-decoration: none; display: flex; align-items: center; color:#f0f0f0 !important;">
        ...
        <div class="employee-information-container">
            ...
            <div class="information-content">
                ...
                <div id="payrollSystem" class="info-section-content">
                    ...
                    <br>
                    <label>Date To:</label>
                    <input type="date" id="date_from" name="date_to">
                    ...
                    <div class="payroll-container">
                        ...
                        <div class="payroll-box deductions">
                            ...
                            <label>SSS:</label>
                            <input type="number" id="sss" value="500" placeholder="Enter amount" onchange="calculateTotalDeductions()" readonly>

                            <label>PhilHealth:</label>
                            <input type="number" id="philhealth" value="500" placeholder="Enter amount" onchange="calculateTotalDeductions()" readonly>

                            <label>PAGIBIG:</label>
                            <input type="number" id="pagibig" value="500" placeholder="Enter amount" onchange="calculateTotalDeductions()" readonly>
                    ...
                    <div class="employee-details" style="margin-bottom: 20px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; margin-top: 10px;">
                            ...
                            <div>
                                ...
                                <div class="info-field"><?php echo htmlspecialchars($employee['rate_position']); ?></div>
                            </div>
                        </div>
                    </div>
