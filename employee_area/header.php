  ...
  <div class="header-container">
    ...
    <nav class="nav-section">
      <ul id="nav-menu">
        ...
        <li><a href="./employee_area/homepage.php#about"><i class="fas fa-info-circle"></i> About</a></li>

        <li><a href="projects.php" class="projects-link"><i class="fas fa-project-diagram"></i> Projects</a></li>
        <li><a href="./../employee_area/portal.php" class="admin-button">
